...
--
-- Host: 127.0.0.1
-- Generation Time: Sep 28, 2021 at 04:49 AM
...
INSERT INTO `buku` (`id_buku`, `judul_buku`, `penulis`, `penerbit`, `deskripsi`, `gambar`) VALUES
(3, ' Nathan Sang Pengenbala', 'Fazril Wibu', 'Tokopedei', 'yntkts', ''),
(4, ' Fazril sang pencari mangsa', 'Nathan Loli', 'PDI', 'apa ya', '');

-- --------------------------------------------------------

--
-- Table structure for table `detail_pemimjaman_buku`
--

CREATE TABLE `detail_pemimjaman_buku` (
...
(7, 50, '2021-09-24', '2021-09-29'),
(8, 50, '2021-09-28', '2021-10-03'),
(9, 50, '2021-09-28', '2021-10-03');
...
INSERT INTO `perpustakaan` (`id_buku`, `judul_buku`, `penulis`, `penerbit`) VALUES
(1, ' Udin Si anak baik', 'Udin Subarjo', 'Gramedia'),
(2, ' Fazril si Anak Nakal', 'Nanda Ricco', 'Roxier5'),
(3, ' Udin Si anak baik', 'Udin Subarjo', 'Gramedia');
...
(50, 'Karuizawa Kei', '2021-09-24', 'P', 'Malang', '123', '202cb962ac59075b964b07152d234b70', 3, 6);
...
--
-- Indexes for table `detail_pemimjaman_buku`
--
ALTER TABLE `detail_pemimjaman_buku`
...
--
-- AUTO_INCREMENT for table `detail_pemimjaman_buku`
--
ALTER TABLE `detail_pemimjaman_buku`
...
--
ALTER TABLE `peminjaman_buku`
  MODIFY `id_peminjaman_buku` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=10;
...
--
-- Constraints for table `detail_pemimjaman_buku`
--
ALTER TABLE `detail_pemimjaman_buku`
  ADD CONSTRAINT `detail_pemimjaman_buku_ibfk_2` FOREIGN KEY (`id_buku`) REFERENCES `buku` (`id_buku`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `detail_pemimjaman_buku_ibfk_3` FOREIGN KEY (`id_peminjaman_buku`) REFERENCES `peminjaman_buku` (`id_peminjaman_buku`) ON DELETE CASCADE ON UPDATE CASCADE;
